...
If you want to see what this looked like in practice, the beta migration landed first in [PR #1452](https://github.com/CommunityToolkit/Aspire/pull/1452), and the stable release follow-up went into [PR #1453](https://github.com/CommunityToolkit/Aspire/pull/1453). That sequencing was deliberate: prove the pattern on the beta path, then roll it forward to the stable one once the moving parts were understood.
